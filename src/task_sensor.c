...
{	
	...
	therm_t termistor3;
	ESP_ERROR_CHECK(therm_config(&termistor3, adc_hdlr, THERMISTOR_ADC_CHANNEL3, THERMISTOR3_ADC_CHANNEL_ON_OFF));
	...
	ESP_ERROR_CHECK(adc_oneshot_config_channel(adc_hdlr, THERMISTOR_ADC_CHANNEL3, &channel_cfg));
